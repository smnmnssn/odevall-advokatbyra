    ...
    <div id="wrapper">
      <FadeInSection>
        <div className="text-center p-2">
          <h1 className="font-bold fontsans">VÅR EXPERTIS</h1>
          <p>
            Odevall Advokatbyrå i Göteborg erbjuder flertalet juridiska
            tjänster, både för privatpersoner och företagare. Våra advokater har
      ...
      <FadeInSection>
        <Accordion type="single" collapsible className="text-black border border-black">
